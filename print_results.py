...
def print_results(results_dic, results_stats_dic, model,
    ...
    for key in results_stats_dic:
        # Printing out all the percentages
        # in the results_stats_dic dictionary. All percentages in results_stats_dic
        # have 'keys' that start with the letter p.
    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            ...
            if sum(results_dic[key][3:]) == 1:
                print("{} classified as {}".format(results_dic[key][0], results_dic[key][1]))
