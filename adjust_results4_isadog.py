...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    """
    # Creating dognames dictionary for quick matching to results_dic labels from
    # real answer & classifier's answer
    dognames_dic = dict()

    # Reading in dognames from file, 1 name per line & automatically closes file
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # removing the newline from the variable line
            line = line.strip()

            # Checking if the line with a dog name
            # exists within dognames_dic. If not
            # it gets added as the 'key' with the 'value' of 1.
    ...
    # Appending results_dic with the following:
