...
def classify_images(images_dir, results_dic, model):
    ...
    # Process all files in the results_dic to add the NEW indexes
    for key in results_dic:
       ...
       # Running classifier function to classify the images classifier function
       # inputs: path + filename  and  model, returns model_label
       # as classifier label. Also converting to lowercase and removing whitespace
       model_label = classifier(images_dir + key, model).lower().strip()

       # defining truth as pet image label
       truth = results_dic[key][0]

       # Using the extend list function
       ...
       # Using the extend list function again
       # to add the classifier label (model_label) and the value of
